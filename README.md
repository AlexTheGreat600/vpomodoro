...
- **🎲 Random Activity Mode** – Let the timer pick a random activity for you
...
Simply open `vpomodoro.html` in your browser. No installation or dependencies required!
...
- [**Google Fonts**](https://fonts.google.com/)
  ...
  - **Roboto Slab** – Geometric slab serif
  - **Montserrat** – Bold geometric sans-serif

## 💝 Handcrafted By

Built with ❤️ by **Shivansh** & **Gemini**
